const CategoryService = {
    ...
    getCategoryArray() {
        return fetch(`${process.env.REACT_APP_API_ENDPOINT}/categories`, {})
            .then((res) =>
    ...
    getStacksByCategory(categoryID) {
        return fetch(
            `${process.env.REACT_APP_API_ENDPOINT}/categories/${categoryID}/stacks`,
            {}
        )
            .then((res) =>
                !res.ok ? res.json().then((e) => Promise.reject(e)) : res.json()
    ...
    getCardsByCategoryAndStack(categoryID, stackID) {
        return fetch(
            `${process.env.REACT_APP_API_ENDPOINT}/categories/${categoryID}/stacks/${stackID}/cards`,
            {}
    ...
    newCategory(categoryData) {
        ...
        return fetch(
            `${process.env.REACT_APP_API_ENDPOINT}/categories/newCategory`,
            {
                method: 'POST',
                headers: {
    ...
    newStack(categoryID, stackData) {
        ...
        return fetch(
            `${process.env.REACT_APP_API_ENDPOINT}/categories/${categoryID}/newStack`,
            {
                method: 'POST',
                headers: {
                    'content-type': 'application/json',
    ...
    updateCategory(categoryID, updatedCategoryData) {
        ...
        return fetch(
            `${process.env.REACT_APP_API_ENDPOINT}/categories/${categoryID}`,
            {
                method: 'PATCH',
                headers: {
                    'content-type': 'application/json',
    ...
    updateStack(categoryID, stackID, updatedStackData) {
        ...
        return fetch(
            `${process.env.REACT_APP_API_ENDPOINT}/categories/${categoryID}/stacks/${stackID}`,
            {
                method: 'PATCH',
                headers: {
                    'content-type': 'application/json',
    ...
    updateCard(categoryID, stackID, cardID, updatedCardData) {
        ...
        return fetch(
            `${process.env.REACT_APP_API_ENDPOINT}/categories/${categoryID}/stacks/${stackID}/cards/${cardID}`,
            {
                method: 'PATCH',
                headers: {
                    'content-type': 'application/json',
